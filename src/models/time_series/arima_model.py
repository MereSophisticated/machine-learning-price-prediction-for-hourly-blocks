...
from src.data_analysis.data_retrieval import get_intra_day_data_for_region
...
def best_interval(date="2022-02-10", number_of_days=5, freq=9, start_time=4, end_time=6):
    ...
    for i in np.linspace(start_time, end_time, freq):
        in_ten_prct, in_twenty_prct, in_thirty_prct, in_fifty_prct, in_hundred_prct, delez, napaka_abs_all = plot_plot(
            date, number_of_days, i)
